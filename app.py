...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Văn Duy - Trường PTDTBTTH&THCS Sà Phìn - ĐT: 0393856872 </p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Văn Duy - Trường PTDTBTTH&THCS Sà Phìn - ĐT: 0393856872</div>", unsafe_allow_html=True)
